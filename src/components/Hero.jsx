...
const Hero = () => {
  return (
    <div className="relative h-[calc(100vh-75px)] px-4 lg:px-20 xl:px-30 mt-[75px] bg-[url('https://cutewallpaper.org/21/white-background-gif/Tag-For-White-Background-File-Hart-S-Inversor-On-White-.gif')] bg-cover bg-center bg-no-repeat">
